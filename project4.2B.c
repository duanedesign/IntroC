...
/* determine quadrant or axis from user input */
     if (angle  <0 || angle >=360)
         printf ("angle must be between 0-359. Please try again. \n");
     else if (angle  == 0)
         printf ("0 is the positive X-axis. \n");
     else if (angle == 90)
         printf ("90 is the positive Y-axis. \n");
     else if (angle == 180)
         printf ("180 this is the negative X-axis. \n");
     else if (angle  == 270)
         printf ("270 is the negative Y-axis. \n");
